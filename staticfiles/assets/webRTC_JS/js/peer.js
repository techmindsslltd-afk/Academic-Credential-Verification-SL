...
const localVideoJoinUser = document.querySelector('#local-video-oinUser');
...
var userOriginalName = document.querySelector('#userOriginalName');
...
userMedia = navigator.mediaDevices.getUserMedia(constraints)
    .then(stream => {
        ...
        localVideoJoinUser.srcObject = localStream;
        localVideoJoinUser.muted = true;
...
//////////////////////////////////////////////////////////////////
    ...
    messageInput.disabled = false;
		...
		//localVideo.srcObject = mediaTracks[0];
		//console.log('First User:', mediaTracks[0]);
}
...
function startVideoConferencing(){
...
///////////////////////////////////////////////////////////////////////////////////////////
   ...
   var element = document.getElementById("startVideoConferencing");
    element.style.display = "none";
   var element = document.getElementById("endVideoConferencing");
            ...
            navigator.mediaDevices.getDisplayMedia(constraints)
                .then(stream => {
                    ...
                    for(i=0; i < mediaTracks.length; i++){
                       ...
                       //const localScreen = document.querySelector('#local-video');
                    ...
                    // if screen not shared
					 //localScreen.replaceTrack(localDisplayStream.getTracks()[0]);
...
function createVideo(peerUsername){
	...
	var withNoDigits = peerUsername.replace(/[0-9]/g, '');
	usernamep.innerText = withNoDigits;

    // add the wrapper to the video container
    videoContainer.appendChild(videoWrapper);

    // add the video to the wrapper
    videoWrapper.appendChild(usernamep);
...
function createVideo_2(peerUsername){
    var localVideoDiv = document.querySelector('#local-video-div');
    ...
    // add the wrapper to the video container
    localVideoDiv.innerHTML(videoWrapper);
...
function handleSuccess(stream) {
  startButtonShare.disabled = true;
  ...
  stream.getVideoTracks()[0].addEventListener('ended', () => {
    ...
    startButtonShare.disabled = false;
  });
}
...
const startButtonShare = document.getElementById('startButtonShare');
startButtonShare.addEventListener('click', () => {
